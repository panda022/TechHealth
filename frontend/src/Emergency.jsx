...
const Emergency = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const message = `
    Let us do role play, assume your a are qualified healthcare professional. You can
    give advice for me who have an emergency medical situation or are uncertain whether a condition requires immediate hospital care.
    I've completed an emergency form and need advice on whether to visit an emergency center or call 911. Please respond with 'Yes' or 'No' first, 
    followed by your reasoning(The reasoning should be limited in 1 sentences).
    ...
    // Pass Data Between Components
     // Redirect to ChatAI and pass the message
    navigate('/chatAI', { state: { message } });
  };
